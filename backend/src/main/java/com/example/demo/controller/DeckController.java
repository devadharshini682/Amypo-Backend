...
public class DeckController {
    ...
    public DeckController(DeckManagementService deckManagementService) {
    ...
    public ResponseEntity<String> createDeck(
        ...
        deckManagementService.createDeck(request);
    ...
    public ResponseEntity<String> updateDeck(
        ...
        deckManagementService.updateDeck(id, request);
    ...
    public ResponseEntity<StudyDeck> cloneDeck(@PathVariable Long id) {

        return ResponseEntity.ok(
                deckManagementService.cloneDeck(id)
        );
    }
}