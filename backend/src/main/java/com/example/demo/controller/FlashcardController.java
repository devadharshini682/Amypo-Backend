...
public class FlashcardController {
    ...
    public FlashcardController(DeckManagementService deckManagementService) {
    ...
    public ResponseEntity<List<Flashcard>> getFlashcards(
        ...
        return ResponseEntity.ok(
                deckManagementService.getFlashcardsByDeck(deckId)
        );
    }

    @PostMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'LINGUIST')")
    public ResponseEntity<Flashcard> createFlashcard(
            @Valid @RequestBody FlashcardRequestDto request) {

        return ResponseEntity.ok(
                deckManagementService.createFlashcard(request)
        );
    }
    ...
    public ResponseEntity<Flashcard> updateFlashcard(
        ...
        return ResponseEntity.ok(
                deckManagementService.updateFlashcard(id, request)
        );
    }
    ...
    public ResponseEntity<String> deleteFlashcard(
        ...
        deckManagementService.deleteFlashcard(id);
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'LINGUIST', 'LEARNER')")
    public ResponseEntity<Flashcard> updateReviewStatus(
            @PathVariable Long id,
            @RequestParam String status) {

        return ResponseEntity.ok(
                deckManagementService.updateReviewStatus(id, status)
        );
    }
}